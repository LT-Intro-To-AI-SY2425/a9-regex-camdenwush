...
def get_planet_radius(planet_name: str) -> str:
    ...
    pattern = r"Polar radius[^0-9]*?(?P<radius>[\d,]+\.?\d*)"
...
if __name__ == "__main__":
    ...
    assert get_planet_radius("Jupiter") == "66854", "Incorrect radius for Jupiter" # BeautifulSoup returns numbers without separators
    assert get_planet_radius("Saturn") == "54364", "Incorrect radius for Saturn" # BeautifulSoup returns numbers without separators
